...
!function () {
  if ("undefined" == typeof BloggerRatingGenerator) {
    ...
    function r(t, r, l, i) {
      let n = document.createElement("div"); n.setAttribute("class", "BloggerStarRating mt-5"), "insertAfter" === l ? t.parentNode.insertBefore(n, t.nextSibling) : t.appendChild(n);
      let o = document.createElement("script");
      for (let t in i) o.setAttribute(t, i[t]);
      o.setAttribute("id","mStars"),
      o.setAttribute("ratingName", e(r)), o.src = "https://cdn.jsdelivr.net/gh/mohanjeetsingh/mStars@latest/mStarCore.js", n.appendChild(o)
    }
