  ...
  if ("undefined" == typeof BloggerRatingGenerator) {
    ...
    function t(e) {
      if ("A" === e.tagName && e.getAttribute("href")) {
        let r = e.getAttribute("href").split("?")[0].split("#")[0]; return 0 === r.indexOf(location.protocol + "//" + location.host) && /.*\/\d{4}\/\d{2}\/.*\.html/.test(r) ? e : e.parentNode && "main" !== e.parentNode.id && e.parentNode !== document.body ? t(e.parentNode) : null
      }
    }
    function e(t) {
      let e = t.split("?")[0].split("#")[0].replace("https:", "").replace("http:", "").replace("file:", "").replace("ftp:", "").replace("mailto:", ""); for (; "/" == e[0];)e = e.substring(1); for (0 === e.indexOf("www.") && (e = e.replace("www.", "")); "/" == e[e.length - 1];)e = e.substring(0, e.length - 1); return e = e.replace(/\./g, "_").replace(/\//g, "__").replace(/\,/g, "___").replace(/\s/g, "")
    }
    function r(t, r, l, i) { let n = document.createElement("div"); n.setAttribute("class", "BloggerStarRating mt-5"), "insertAfter" === l ? t.parentNode.insertBefore(n, t.nextSibling) : t.appendChild(n); let o = document.createElement("script"); for (let t in i) o.setAttribute(t, i[t]); o.setAttribute("ratingName", e(r)), o.src = "https://cdn.jsdelivr.net/gh/starratingsystem/script@1.0.1/starrater.js", n.appendChild(o) }
